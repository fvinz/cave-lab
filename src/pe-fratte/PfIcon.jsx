/* Icone della pagina Pe' Fratte: tracciati Lucide (tratto 2px, terminali
   arrotondati), come da design system. Inline, niente CDN. */
const PATHS = {
...
export default function PfIcon({ name, className = "pf-icon" }) {

...
const PATHS = {
  ...
  mountain: (
    <>
      <path d="M2.5 20l7-12 4 6.5 2.5-3.5 5.5 9z" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
      <path d="M7.6 11.3l1.9 1.4 1.8-1.4" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </>
  ),
  instagram: (
    <>
  ...
  /* Glifo WhatsApp ufficiale (pieno): un tracciato a mano deformava
     codina del fumetto e cornetta. */
